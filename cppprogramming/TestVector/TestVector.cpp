...
int main() {
	...
	//用迭代器拷贝words1的内容创建words2
	std::vector<std::string> words2(words1.begin()+2,words1.end());
	//std::vector words2(words1.begin(),words1.end());为什么错？？cpp17标准 模板类参数类型推导
	PRINT(words2);
	...
	std::vector<std::string> words4(4, "cpp");
	PRINT(words4);
